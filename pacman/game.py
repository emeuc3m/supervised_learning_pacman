...
class Actions(object):
    ...
    def getLegalNeighbors(position, walls):
        ...
        for dir, vec in Actions._directionsAsList:
            ...
            if not walls[next_x][next_y]: neighbors.append([(next_x, next_y),dir]) # WE ADDED THE DIRECTION HERE AS WELL, IT MAY BREAK
        return neighbors
...
class Game(object):
    ...
    def run( self ):
        ...
        '''NEW'''
        #save in .arff file the very last instance
        #print(self.agents[0])
        observation = self.agents[0].observationFunction(self.state.deepCopy())
        self.agents[0].getAction(observation)
